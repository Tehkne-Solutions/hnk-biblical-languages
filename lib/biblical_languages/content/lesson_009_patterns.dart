...
final lesson009Patterns = <ComparativePattern>[
  _p(1, 'FELIZ / BEM-AVENTURADO', 'O Salmo abre com fórmula de felicidade, não com cópula explícita.', [_pt('feliz / bem-aventurado'), _eo('feliĉa'), _he('אַשְׁרֵי', 'ashrei'), _gr('μακάριος', 'makarios', n: 'ponte lexical')]),
  ...
  _p(5, 'PERVERSOS', 'Categoria ética lexical sem identificar pessoas automaticamente.', [_pt('perversos'), _eo('malvirtuloj'), _he('רְשָׁעִים', 'resha‘im'), _gr('ἀσεβεῖς', 'asebeis', n: 'ponte lexical')]),
  _p(6, 'CAMINHO DE PECADORES', 'Relação nominal e imagem sapiencial.', [_pt('caminho de pecadores'), _eo('vojo de pekuloj'), _he('דֶרֶךְ חַטָּאִים', 'derekh chatta’im'), _gr('ὁδὸς ἁμαρτωλῶν', 'hodos hamartōlōn', n: 'ponte lexical')]),
  ...
  _p(9, 'A LEI', 'νόμος e תּוֹרָה são aproximados lexicalmente, não equivalentes absolutos.', [_pt('a Lei / instrução'), _eo('la Leĝo'), _he('תּוֹרָה', 'torah', n: 'ponte lexical'), _gr('τὸν νόμον', 'ton nomon')]),
  _p(10, 'OS PROFETAS', 'Categoria textual/pessoal de Mateus.', [_pt('os Profetas'), _eo('la Profetoj'), _he('הַנְּבִיאִים', 'hannevi’im', n: 'ponte lexical'), _gr('τοὺς προφήτας', 'tous prophētas')]),
  _p(11, 'NÃO ABOLIR', 'καταλύω mantém seu campo lexical antes da exegese.', [_pt('não abolir / desfazer'), _eo('ne nuligi'), _he('לֹא … הֵפֵר', 'lo … hefer', n: 'ponte lexical'), _gr('οὐκ … καταλῦσαι', 'ouk … katalysai')]),
  _p(12, 'MAS CUMPRIR', 'A adversativa real pertence ao Grego; a linha hebraica é só ponte lexical.', [_pt('mas cumprir / completar'), _eo('sed plenumi'), _he('מָלֵא', 'male', n: 'ponte lexical; sem adversativa hebraica inventada'), _gr('ἀλλὰ πληρῶσαι', 'alla plērōsai')]),
];